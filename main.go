...
const (
	...
	DISTANCE = "200km"
	// Needs to update
	PROJECT_ID  = "around-206421"
	BT_INSTANCE = "around-post"
	// Needs to update this URL if you deploy it to cloud.
	ES_URL      = "http://35.239.65.188:9200"
	BUCKET_NAME = "post-images-206421"
	API_PREFIX  = "/api/v1"
)
...
func handlerPost(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content_Type", "apllication/json")
	...
	//Parse form data
	fmt.Println("Received one post reques %s\n", r.FormValue("message"))
	...
	//file already consume (file inputstream), we need to reread it
